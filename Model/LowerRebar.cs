...
public class LowerRebar
{
	...
	public List<List<Curve>> Curves { get; set; } = new();
	...
	private void RebarAnalys()
	{
		...
		Start = Start.Add(BeamInfo.Height.MmToFeet() * -XYZ.BasisZ);
		End = End.Add(BeamInfo.Height.MmToFeet() * -XYZ.BasisZ);
		...
		var width = (BeamInfo.Width - 100).MmToFeet();
